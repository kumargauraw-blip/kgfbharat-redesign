                ...
                <div className="grid lg:grid-cols-2 items-center gap-20">
                    <div className="space-y-12 text-center lg:text-left">
                        ...
                        <div className="flex flex-col sm:flex-row items-center gap-6 justify-center lg:justify-start">
                            ...
                            <Link href="/about" className="w-full sm:w-auto px-12 py-6 bg-white text-[#111827] border-2 border-gray-200 rounded-[2rem] font-black text-sm uppercase tracking-widest hover:bg-gray-50 transition-all text-center">
                                Our Impact
                            </Link>
                        </div>
                    </div>
                    ...
                    <div className="relative hidden lg:block">
                        ...
                        <div className="absolute -top-10 -right-10 bg-white p-8 rounded-[2.5rem] shadow-2xl z-20 border border-gray-100 text-center animate-pulse">
                            <p className="text-4xl font-black text-[#111827] leading-none mb-1">AI</p>
