    ...
    return (
        <div className="min-h-screen bg-off-white">
            ...
            <div className="container-custom py-16">
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className={`w-14 h-14 rounded-2xl flex items-center justify-center mb-6 ${
                                    ...
                                    tier.color === "blue-600" ? "bg-blue-50" :
                                    "bg-navy/10"
                                }`}>
                                    <Icon className={`w-7 h-7 ${
                                        tier.color === "orange" ? "text-orange" :
                                        tier.color === "blue-600" ? "text-blue-600" :
                                        "text-navy"
                                    }`} />
                                </div>

                                <h3 className="text-xl font-black text-navy mb-1">{tier.name}</h3>
                                ...
                                <button
                                    ...
                                    className={`w-full py-3.5 rounded-xl font-bold uppercase tracking-wider text-sm transition-all ${
                                        tier.popular
                                            ? "bg-orange hover:bg-orange-light text-white shadow-lg shadow-orange/20"
                ...
                >
                    <h3 className="text-xl font-black text-navy mb-2">Custom Amount</h3>
                    ...
                    <div className="flex gap-3">
                        <div className="relative flex-1">
                            ...
                            <input
                                ...
                                className="w-full pl-12 pr-4 py-3.5 rounded-xl border border-gray-200 focus:border-orange focus:ring-2 focus:ring-orange/20 outline-none transition-all text-navy font-bold"
                            />
                        </div>
                        <button
                            onClick={() => {
                            ...
                            className="bg-orange hover:bg-orange-light text-white px-6 py-3.5 rounded-xl font-bold uppercase tracking-wider text-sm transition-all shadow-lg shadow-orange/20 shrink-0"
                        >
                            Donate
                        </button>
                    </div>
